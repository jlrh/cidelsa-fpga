-- captura escena de GAMEPLAY (inyecta moneda+start). Config por render (pageram).
local TARGET=tonumber(os.getenv("CIDELSA_FRAME")) or 620
local DIR=(os.getenv("CIDELSA_DIR") or "C:/_PROYECTOS/Cidelsa/debug/destryer/gameplay").."/"
...
emu.register_frame_done(function()
  ...
  print(string.format(">>> gameplay f%d DISPLAY: col=%d cfc=%d bkg=%d dbl=%d fhz=%d fvt=%d l9=%d hma=0x%x",
     f,reg_disp.col,reg_disp.cfc,reg_disp.bkg,reg_disp.dblpage,reg_disp.freshorz,reg_disp.fresvert,reg_disp.line9,reg_disp.hma)); m:exit()
end)
